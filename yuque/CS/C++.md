...
原始字符串字面量（raw string literal)<br />R " [d-char-sequence](%C2%B7%C2%B7%C2%B7)[d-char-sequence] "<br />可选分隔符序列 <= 16个字符，前后一致<br />​
...
<a name="Z2qIr"></a>
## [<br />](https://zh.cppreference.com/w/cpp/header/numeric)
**数值运算**
...
# 动态内存
<a name="he7ol"></a>
## [<br />](https://zh.cppreference.com/w/cpp/header/new)
| 函数 |  |
| --- | --- |
...
<a name="RUlFG"></a>
## [ ](https://zh.cppreference.com/mwiki/index.php?title=cpp/header/memory&variant=zh-cn)
<a name="z0gme"></a>
### 智能指针
...
# 数值
<a name="YIEis"></a>
## [<br />](https://zh.cppreference.com/w/cpp/header/random)
| 均匀随机位生成器要求 |  |
| --- | --- |
...
<a name="iL10J"></a>
## [<br />](https://zh.cppreference.com/w/cpp/header/complex)
...
<a name="yVgKC"></a>
## [<br />](https://zh.cppreference.com/mwiki/index.php?title=cpp/header/ratio&variant=zh-hans)
| 算术 |  |
| --- | --- |
...
<a name="DacTF"></a>
## [<br />](https://zh.cppreference.com/mwiki/index.php?title=cpp/header/chrono&variant=zh-hans)
**类**
...
# 异常
<a name="o2ahc"></a>
## [<br />](https://zh.cppreference.com/w/cpp/header/exception)
| 类 |  |
| --- | --- |
...
<a name="CreVp"></a>
## [<br />](https://zh.cppreference.com/w/cpp/header/stdexcept)
...
<a name="xNId1"></a>
## [<br />](https://zh.cppreference.com/w/cpp/header/regex)
| 类型 |  |
| --- | --- |
...
# 线程
<a name="Hs4Oo"></a>
## [<br />](https://zh.cppreference.com/w/cpp/header/thread)
...
<a name="cLL38"></a>
## [<br />](https://zh.cppreference.com/w/cpp/header/atomic)
| 类 |  |
| --- | --- |
...
| 类 |  |
| --- | --- |
| [mutex ](https://zh.cppreference.com/w/cpp/thread/mutex)<br />(C++11) | 提供基本互斥设施 (类) |
| [timed_mutex ](https://zh.cppreference.com/w/cpp/thread/timed_mutex)<br />(C++11) | 提供互斥设施，实现有时限锁定 (类) |
| [recursive_mutex ](https://zh.cppreference.com/w/cpp/thread/recursive_mutex)<br />(C++11) | 提供能被同一线程递归锁定的互斥设施 (类) |
| [recursive_timed_mutex ](https://zh.cppreference.com/w/cpp/thread/recursive_timed_mutex)<br />(C++11) | 提供能被同一线程递归锁定的互斥设施，并实现有时限锁定 (类) |
| [lock_guard ](https://zh.cppreference.com/w/cpp/thread/lock_guard)<br />(C++11) | 实现严格基于作用域的互斥体所有权包装器 (类模板) |
| [unique_lock ](https://zh.cppreference.com/w/cpp/thread/unique_lock)<br />(C++11) | 实现可移动的互斥体所有权包装器 (类模板) |
| [scoped_lock ](https://zh.cppreference.com/w/cpp/thread/scoped_lock)<br />(C++17) | 用于多个互斥体的免死锁RAII封装器 (类模板) |
| [defer_lock_t ](https://zh.cppreference.com/w/cpp/thread/lock_tag_t)<br />try_to_lock_t adopt_lock_t | 用于指定锁定策略的标签类型 (类) |
| [defer_lock ](https://zh.cppreference.com/w/cpp/thread/lock_tag)<br />try_to_lock adopt_lock | 用于指定锁定策略的标签常量 (常量) |
| [once_flag ](https://zh.cppreference.com/w/cpp/thread/once_flag)<br />(C++11) | 确保[call_once只](https://zh.cppreference.com/w/cpp/thread/call_once)<br />调用函数一次的帮助对象 (类) |
| 函数 |  |
| [try_lock ](https://zh.cppreference.com/w/cpp/thread/try_lock)<br />(C++11) | 试图通过重复调用try_lock获得互斥体的所有权 (函数模板) |
| [lock ](https://zh.cppreference.com/w/cpp/thread/lock)<br />(C++11) | 锁定指定的互斥体，若任何一个不可用则阻塞 (函数模板) |
| [call_once ](https://zh.cppreference.com/w/cpp/thread/call_once)<br />(C++11) | 仅调用函数一次，即使从多个线程调用 (函数模板) |
| [std::swap ](https://zh.cppreference.com/w/cpp/thread/unique_lock/swap2) | [std::swap对](https://zh.cppreference.com/w/cpp/algorithm/swap)<br />unique_lock的特化 |

<a name="kJNzV"></a>
## [<br />](https://zh.cppreference.com/mwiki/index.php?title=cpp/header/future&variant=zh-cn)
| 类 |  |
| --- | --- |
