...
FileMenu Tools  <br />  StartIsBack++	[果核剥壳](https://www.ghpym.com/)  <br />  AIDA64	[果核剥壳](https://www.ghpym.com/)
...
局域网精灵	剪贴板共享  <br />  MT管理器	双列文件窗口，修改apk  <br />  应用与系统信息	监控辅助（Activity），测距  <br />  爱玩机工具箱		设备详细详细，应用高级管理，刷机增强，监控辅助，终端
